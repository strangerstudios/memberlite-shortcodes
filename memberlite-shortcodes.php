...
function memberlitesc_init_styles() {
	...
	if ( false === $should_exit ) {
		wp_enqueue_style( 'font-awesome', MEMBERLITESC_URL . '/font-awesome/css/all.min.css', array(), '5.1.1' );
